...
class BCancer(db.Model):
    ...
    radius_se = db.Column(db.Float(100))
    texture_se = db.Column(db.Float(100))
    perimeter_se = db.Column(db.Float(100))
    area_se = db.Column(db.Float(100))
    smoothness_se = db.Column(db.Float(100))
    compactness_se = db.Column(db.Float(100))
    concavity_se = db.Column(db.Float(100))
    symmetry_se = db.Column(db.Float(100))
    fractal_dimension_se = db.Column(db.Float(100))
    texture_worst = db.Column(db.Float(100))
    perimeter_worst = db.Column(db.Float(100))
    area_worst = db.Column(db.Float(100))
    smoothness_worst = db.Column(db.Float(100))
    compactness_worst = db.Column(db.Float(100))
    concavity_worst = db.Column(db.Float(100))
    concave_points_worst = db.Column(db.Float(100))
    symmetry_worst = db.Column(db.Float(100))
    fractal_dimension_worst = db.Column(db.Float(100))
    outcome = db.Column(db.String(10000))
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'))
